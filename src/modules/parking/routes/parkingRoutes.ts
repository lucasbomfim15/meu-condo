...
router.post("/", authenticateJWT, authorizeRole("ADMIN", "USER"), (req, res, next) => parkingController.create(req, res, next));
router.get("/", authenticateJWT, authorizeRole("ADMIN", "USER"), (req, res, next) => parkingController.listAll(req, res, next));
router.get("/:id", authenticateJWT, authorizeRole("ADMIN", "USER"), (req, res, next) => parkingController.findById(req, res, next));
router.put("/:id", authenticateJWT, authorizeRole("ADMIN", "USER"), (req, res, next) => parkingController.update(req, res, next));
