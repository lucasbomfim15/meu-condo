...
router.get("/", authenticateJWT,  (req, res, next) => condominiumController.listAll(req, res, next));
router.get("/:id", authenticateJWT, (req, res, next) => condominiumController.findById(req, res, next));
